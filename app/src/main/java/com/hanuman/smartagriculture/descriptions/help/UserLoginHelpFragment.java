...
import com.hanuman.smartagriculture.databinding.FragmentUserLoginHelpBinding;

public class UserLoginHelpFragment extends Fragment {
    FragmentUserLoginHelpBinding binding;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        binding = FragmentUserLoginHelpBinding.inflate(inflater,container,false);
